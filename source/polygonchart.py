...
class PolygonChart(Chart):
    ...
    def __init__(
        ...
        file_path = "/Users/vsai23/Workspace/PolygonBacktest/source/results/washout/sma9_2023-01-01_2023-06-30.csv"
        if file_path:
    ...
    def _on_row_click(self, row):
        ...
        trades = [(datetime.fromtimestamp(int(trade[0])/1000) + timedelta(hours=5), float(trade[1]), float(trade[2])) for trade in trades]
